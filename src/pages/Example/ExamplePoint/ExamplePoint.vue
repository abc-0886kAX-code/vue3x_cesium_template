...
-->
<script setup>
import { BillboardCollection, LabelCollection, PointPrimitiveCollection } from 'cesium'
  ...
  <div class="ExamplePoint">
    <div class="ExamplePoint-console">
      ...
      <div class="ExamplePoint-console-item">
        ...
        <el-button type="primary" plain @click="iconPointController">
          切换
        </el-button>
      </div>
      <div class="ExamplePoint-console-item">
        <div>文本点位（贴地）-显示隐藏</div>
        <el-button type="primary" plain @click="labelPointController">
          切换
        </el-button>
      </div>
      <div class="ExamplePoint-console-item">
