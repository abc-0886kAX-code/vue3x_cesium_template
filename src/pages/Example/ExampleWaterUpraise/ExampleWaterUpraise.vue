...
let timer = null
// 水体高度
const initialExtrudedHeight = -400
// 距离地面目标高度
...
<template>
  <div class="ExampleWaterUpraise">
    <div class="ExampleWaterUpraise-console">
      ...
      <div class="ExampleWaterUpraise-console-item">
        <div>水体-抬升</div>
        <el-button type="primary" plain :disabled="!state" @click="waterUpraise">
          抬升
        </el-button>
      </div>
      <div class="ExampleWaterUpraise-console-item">
        <div>水体-下降</div>
        <el-button type="primary" plain :disabled="state" @click="waterDrop">
          下降
        </el-button>
      </div>
    </div>
