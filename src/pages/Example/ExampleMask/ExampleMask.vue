 ...
 * @LastEditTime: 2024-07-26 13:45:49
 * @Description:
-->
<script setup>
  ...
  <div class="ExampleMask">
    <div class="ExampleMask-console">
      <div class="ExampleMask-console-item">
        ...
        <el-button type="primary" plain @click="controllerEnity.switch">
          切换
        </el-button>
      </div>
      <div class="ExampleMask-console-item">
        ...
        <el-slider
          class="slider" :model-value="slider" :min="0" :max="1" :step="0.1"
      ...
      <div class="ExampleMask-console-item">
        ...
        <el-button type="primary" plain @click="maskShowOrHide">
          切换
        </el-button>
      </div>
      <div class="ExampleMask-console-item">
        ...
        <el-button type="primary" plain @click="lineShowOrHide">
          切换
        </el-button>
      </div>
    </div>
