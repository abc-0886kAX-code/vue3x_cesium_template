...
import { Cartesian3, CzmlDataSource, LagrangePolynomialApproximation, Matrix4, HeadingPitchRange, Transforms, Matrix3, Math as CesiumMath, ClockRange } from "cesium"
...
function setRoamView() {
    if (unref(flyEntity)) {
        ...
        if (prePoint) {
            let heading = getHeading(prePoint, center)
            let pitch = CesiumMath.toRadians(-25.0);
            let range = 100;
...
<template>
    <div class="ExampleRoam">
        <div class="ExampleRoam-console">
            ...
            <div class="ExampleRoam-console-item">
                <div>漫游-创建</div>
                <el-button type="primary" plain @click="createRoam">创建</el-button>
            </div>
            <div class="ExampleRoam-console-item">
                <div>漫游-开始</div>
            ...
            <div class="ExampleRoam-console-item">
                <div>漫游-暂停</div>
                <el-button type="primary" plain @click="onPause">暂停</el-button>
            </div>
            <div class="ExampleRoam-console-item">
                <div>漫游-结束</div>
