 ...
 * @Description:
 */
import { Cartesian3, GeometryInstance, GroundPrimitive, Material, PolygonGeometry, PolygonHierarchy, PolylineMaterialAppearance } from 'cesium'
      ...
      geometryInstances: new GeometryInstance({
        geometry: new PolygonGeometry({
          polygonHierarchy: new PolygonHierarchy(
            Cartesian3.fromDegreesArray(GlobalMap[0]),
            [empty],
          ),
        }),
        id: attr ?? {},
