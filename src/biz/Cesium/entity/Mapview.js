 ...
 */
import { Cartesian3, EventHelper, Ion, Math, UrlTemplateImageryProvider, Viewer, WebMapTileServiceImageryProvider, WebMercatorTilingScheme } from 'cesium'
...
export class Mapview {
  ...
  install(mapbox) {
    ...
    this.view.scene.debugShowFramesPerSecond = !!DEV // 显示帧率
    ...
    // 修改homeButton的默认返回位置
    const _that = this
    this.view.homeButton.viewModel.command.beforeExecute.addEventListener((e) => {
      e.cancel = true
